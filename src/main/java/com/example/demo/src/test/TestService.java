...
public class TestService {
    ...
    public int checkMemo(String memo) throws BaseException{
        try{
            ...
            List<Memo> memoList = memoRepository.findByMemoAndState(memo, BaseEntity.State.ACTIVE);
    ...
    public List<GetMemoDto> getMemos() throws BaseException{
        try{
            ...
            List<Memo> memoList = memoRepository.findAllByState(BaseEntity.State.ACTIVE);
    ...
    public void modifyMemo(Long memoId, MemoDto memoDto) throws BaseException{
        try{
            ...
            Memo memo = memoRepository.findByIdAndState(memoId, BaseEntity.State.ACTIVE).get();
            if(memo == null){
    ...
    public void createComment(PostCommentDto postCommentDto) throws BaseException {
        ...
        try{
            ...
            Memo memo = memoRepository.findByMemoAndState(postCommentDto.getMemoId(), BaseEntity.State.ACTIVE).get();
